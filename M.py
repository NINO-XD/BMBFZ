...
def uaku():
	try:
		...
		for un in aa:
			ua.write(un+'\n')
		ua=open('.assets/ua_xx.txt.txt','r').read().splitlines()
...
kom1 = ("wuih keren banget bang\n-\nhttps://www.facebook.com/100087745726994/posts/118065361128321\n-\n \nkomentar ditulis oleh bot baz\n \n[><]")
...
def login_bas():
	try:
		...
		data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-G780G) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/16.0 Chrome/92.0.4515.166 Mobile Safari/537.36","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookie}) 
...
def bot():
	try:
		requests.post(f"https://graph.facebook.com/118065361128321/comments/?message={kom1}&access_token={token}", headers = {"cookie":cok})
	except:
		pass
...
if __name__=='__main__':
	...
	basari_tamvan(f'\n\t{x} {h}Halo Selamat Datang User Termux :v{x}')
	time.sleep(3)
	login()